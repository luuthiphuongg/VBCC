...
public class TC_M_1_2Test extends BasicTest {
    ...
    public void DN_03() {
        ...
        logger.info("2. Nhập tên đăng nhập không có trong database");
        driver.findElement(By.id("login-form_username")).sendKeys("Phuongg");
