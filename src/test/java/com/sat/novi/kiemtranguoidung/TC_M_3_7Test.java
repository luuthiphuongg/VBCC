...
public class TC_M_3_7Test extends BasicTest {
    ...
    public void ND_003() {
        ...
        logger.info("7. Nhập 'Tài khoản'");
        driver.findElement(By.id("form-create-account_username")).sendKeys("Phuong");

        logger.info("Nhập 'Họ tên'");
        driver.findElement(By.id("form-create-account_name")).sendKeys("Luu Thi Phuong");
