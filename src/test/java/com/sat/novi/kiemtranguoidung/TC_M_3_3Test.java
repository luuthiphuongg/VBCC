...
public class TC_M_3_3Test extends BasicTest {
    ...
    public void TC_3_3() {
        ...
        driver.findElement(By.id("form-create-account_email")).sendKeys("sat");
        ...
        logger.info("Xác minh thông báo 'Email không đúng định dạng' hiển thị dưới Email");
        String alertTaikhoan= driver.findElement(By.xpath("//*[@role='alert']")).getText(); 
        Assert.assertTrue(alertTaikhoan.contains("Email không đúng định dạng"));
