...
public class TC_M_3_1Test extends BasicTest {
    ...
    public void TC_3_1() {
        ...
        driver.findElement(By.id("form-create-account_username")).sendKeys("xy");
        ...
        logger.info("Xác minh thông báo 'Độ dài từ 3-20 ký tự' hiển thị dưới Tài khoản");
        String alertTaikhoan= driver.findElement(By.xpath("//*[@role='alert']")).getText(); 
        Assert.assertTrue(alertTaikhoan.contains("Độ dài từ 3-20 ký tự"));
