...
public class TC_M_3_5Test extends BasicTest {
    ...
    public void TC_3_5() {
        ...
        logger.info("Xác minh thông báo 'Trường này không được để trống!' hiển thị dưới Nhóm người dùng");
        String alertNguoidung= driver.findElement(By.xpath("//*[@role='alert']")).getText(); 
