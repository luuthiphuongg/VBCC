...
public class TC_M_2_1Test extends BasicTest {
    ...
    public void TC_2_1() {
        ...
        logger.info("Xác minh 'Trường này không được để trống!' đối với Tên và Loại phôi");
        ...
        String alertLoaiphoi = driver.findElement(By.xpath("(//*[@role='alert'])[2]")).getText(); 
