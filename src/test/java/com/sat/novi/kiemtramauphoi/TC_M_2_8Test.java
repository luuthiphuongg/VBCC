...
public class TC_M_2_8Test extends BasicTest {
    ...
    public void TC_2_8() {
        ...
        logger.info("Xác minh 'Bạn chắc chắn muốn xóa?' text hiển thị");
        String text = driver.findElement(By.xpath("//div[contains(@class,'popconfirm')]//div[@class='ant-popover-message-title']")).getText();
        Assert.assertTrue(text.equals("Bạn chắc chắn muốn xóa?"));
    }
}
